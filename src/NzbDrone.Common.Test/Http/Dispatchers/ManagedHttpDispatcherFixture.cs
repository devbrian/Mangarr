...
namespace NzbDrone.Common.Test.Http.Dispatchers
{
    ...
    /// concatenated UA like <c>Sonarr/4.0 Mangarr/0.1</c> on outbound traffic and
    ...
    public class ManagedHttpDispatcherFixture : TestBase
    {
        ...
        {
            // Arrange — pre-seed the request message with the Sonarr-default UA the way
            ...
            // survives; no Sonarr/* product entry remains.
            using var requestMessage = new HttpRequestMessage();
            requestMessage.Headers.UserAgent.ParseAdd("Sonarr/4.0.0");
            ...
            // The exact toString form is "Mangarr/1.2" with no leading "Sonarr/..." segment.
            requestMessage.Headers.UserAgent.ToString().Should().Be("Mangarr/1.2");
            requestMessage.Headers.UserAgent.ToString().Should().NotContain("Sonarr");
        }
