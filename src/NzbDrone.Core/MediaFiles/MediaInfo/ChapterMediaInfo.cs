namespace NzbDrone.Core.MediaFiles.MediaInfo
{
    ...
    // Migration 004); round-tripped via the EmbeddedDocumentConverter<ChapterMediaInfo>
    // Dapper TypeHandler registered in TableMapping.cs (R-12 mitigation).
    //
