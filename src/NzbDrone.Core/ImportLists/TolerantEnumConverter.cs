...
namespace NzbDrone.Core.ImportLists
{
    ...
    // .planning/reference/sonarr-vertical-slices/import-lists/TolerantEnumConverter.cs.
    //
    // Original attribution (preserved from upstream):
    // "This class was copied from gubenkoved TolerantEnumConverter.cs file, which is
