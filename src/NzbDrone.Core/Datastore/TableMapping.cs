...
namespace NzbDrone.Core.Datastore
{
    public static class TableMapping
    {
        ...
        private static void RegisterMappers()
        {
            ...
            // Phase 30 Plan 30-05 (II2-03) — ChapterFile.MediaInfo round-trip is handled
            // by the global EmbeddedDocumentConverter auto-registration in
            // RegisterEmbeddedConverter (below) because ChapterMediaInfo implements
            // IEmbeddedDocument. No per-type explicit registration needed.
