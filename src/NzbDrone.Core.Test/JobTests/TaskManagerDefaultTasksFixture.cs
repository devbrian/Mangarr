...
namespace NzbDrone.Core.Test.JobTests
{
    ...
    public class TaskManagerDefaultTasksFixture : TestBase
    {
        ...
        // Phase 39 RETIRE-01: the TaskManager_defaultTasks_registers_ProcessMangaCompletedCommand
        // assertion was REMOVED with the in-process completion poller. ProcessMangaCompletedCommand
        // is deleted in this plan; its defaultTasks row is stripped (the surviving Phase 36
        // RefreshMonitoredMangaDownloadsCommand row drives completed-download import). There is no
        // HousekeepInProcessDownloadsCommand sister assertion to remove (none ever existed).
