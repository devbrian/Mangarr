...
namespace Mangarr.Api.V5.Manga.Queue
{
    ...
    // — see DIVERGENCE.md.
    //
    // Role-match analog: src/Mangarr.Api.V5/Queue/QueueDetailsController.cs (lines 14-77 —
    ...
    // src/Mangarr.Api.V5/Queue/QueueDetailsController.cs post-Tv-namespace-delete) when Tv/ deletes.
