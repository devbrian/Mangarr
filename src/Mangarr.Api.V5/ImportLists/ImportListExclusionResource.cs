...
// triplet (MangaDexId / MalId / AniListId) per Migration 003 + Plan 26-04's
// ImportListExclusion entity shape.
//
// MangaDexId is the canonical UNIQUE-indexed string identifier (see Migration 003);
// MalId + AniListId are optional secondary identifiers that ride alongside for
// AniList-only / MAL-only exclusions where no MangaDex peer exists.
