...
import MangaIndexPoster from 'Manga/Index/Posters/MangaIndexPoster';
...
interface MangaIndexPostersProps {
  items: Manga[];
  sortKey: string;
...
export default function MangaIndexPosters({
  scrollerRef,
  items,
  sortKey,
  jumpToCharacter,
