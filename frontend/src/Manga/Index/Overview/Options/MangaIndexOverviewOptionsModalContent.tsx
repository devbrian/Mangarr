...
import {
  setMangaOverviewOptions,
  useMangaOverviewOptions,
...
interface MangaIndexOverviewOptionsModalContentProps {
  onModalClose(...args: unknown[]): void;
}

function MangaIndexOverviewOptionsModalContent({
  onModalClose,
}: MangaIndexOverviewOptionsModalContentProps) {
  const {
    detailedProgressBar,
    size,
    showMonitored,
  ...
  const onOverviewOptionChange = useCallback(
    ({ name, value }: { name: string; value: unknown }) => {
      setMangaOverviewOptions({ [name]: value });
    },
    []
  );
...
export default MangaIndexOverviewOptionsModalContent;
