...
import MangaIndexTableOptions from './MangaIndexTableOptions';
import styles from './MangaIndexTableHeader.css';

interface MangaIndexTableHeaderProps {
  showBanners: boolean;
  columns: Column[];
  sortKey?: string;
...
function MangaIndexTableHeader(props: MangaIndexTableHeaderProps) {
  ...
  const onSortPress = useCallback(
    (sortKey: string, sortDirection?: SortDirection) => {
      setMangaSort({ sortKey, sortDirection });
    },
    []
  );
...
export default MangaIndexTableHeader;
