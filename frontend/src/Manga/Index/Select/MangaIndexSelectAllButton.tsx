...
interface MangaIndexSelectAllButtonProps
  extends Omit<PageToolbarButtonProps, 'iconName'> {
  isSelectMode: boolean;
}

function MangaIndexSelectAllButton(props: MangaIndexSelectAllButtonProps) {
...
export default MangaIndexSelectAllButton;
