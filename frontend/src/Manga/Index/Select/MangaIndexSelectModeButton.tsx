...
interface MangaIndexSelectModeButtonProps extends PageToolbarButtonProps {
  isSelectMode: boolean;
  onPress: () => void;
}

function MangaIndexSelectModeButton(props: MangaIndexSelectModeButtonProps) {
...
export default MangaIndexSelectModeButton;
