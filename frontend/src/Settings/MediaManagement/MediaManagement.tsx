...
function MediaManagement() {
  ...
  const handleSetMangaNamingSave = useCallback((saveCallback: () => void) => {
  ...
  return (
    <PageContent title={translate('MediaManagementSettings')}>
      <SettingsToolbar
        ...
        hasPendingChanges={mangaNaming.hasPendingChanges || hasPendingChanges}
              ...
              >
                {showAdvancedSettings ? (
                  <FieldSet legend={translate('Folders')}>
                    ...
                    >
                      <FormLabel>
                        {translate('CreateEmptyMangaFolders')}
                      </FormLabel>
                ...
                {showAdvancedSettings ? (
                  <FieldSet legend={translate('Importing')}>
                    ...
                    >
                      <FormLabel>
                        {translate('UserRejectedExtensions')}
                      </FormLabel>
                ...
                <FieldSet legend={translate('FileManagement')}>
                  <FormGroup size={sizes.MEDIUM}>
                    <FormLabel>
                      {translate('UnmonitorDeletedChapters')}
                    </FormLabel>
