// Phase 27.1 Plan 27.1-04 Task 5 — Tags bulk apply/remove/replace content.
// 1:1 mirror of frontend/src/Settings/Indexers/Indexers/Manage/Tags/TagsModalContent.tsx
// per PATTERNS §Manage Subtree. Swaps:
//   * useIndexersData                                  → useImportListsData
//   * indexersTags local variable                      → importListsTags
//   * ApplyTagsHelpTextHowToApplyIndexers translation  → ApplyTagsHelpTextHowToApplyImportLists
//     (verified present in en.json:121)
// Pattern kappa preserved (zero TV-shape tokens).
...
import { useImportListsData } from 'Settings/ImportLists/useImportLists';
