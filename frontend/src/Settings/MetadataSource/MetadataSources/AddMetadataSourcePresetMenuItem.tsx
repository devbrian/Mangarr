...
interface AddMetadataSourcePresetMenuItemProps {
  name: string;
...
function AddMetadataSourcePresetMenuItem({
  name,
  implementation,
  implementationName,
  onPress,
  ...otherProps
}: AddMetadataSourcePresetMenuItemProps) {
...
export default AddMetadataSourcePresetMenuItem;
